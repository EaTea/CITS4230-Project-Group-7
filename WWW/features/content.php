		...
		<article id="features" class="doc">
			...
			<ul class="logo">
				...
				<li>
					...
					<p>
						Yep, we too are looking forward to flooding your emails with more spam (but we really hope that you use our website instead).
					</p>
				</li>
				<li>
					<h2>Offline Storage</h2>
					<p>
						Can't actually get to FMN at a point in time? Never fear! You can use our handy Local Synch feature to get a copy of your to-do list and store it on your computer.
					</p>
				</li>
			</ul>
